...
<button type="button" class="btn px-0 aside-menu-container__aside-menubar d-lg-block d-none sidebar-btn">
    {{-- <img src="{{ asset(getAppLogo()) }}" alt="Logo" class="object-cover sidebar-app-logo" style="background: transparent;"/> --}}
    <img src="{{ asset('assets/image/logo.png') }}" alt="Logo" class="object-cover sidebar-app-logo" style="background: transparent;"/>
</button>
    ...
    <li class="nav-item {{ Request::is('admin/dashboard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           href="{{ route('admin.dashboard') }}">
            ...
            <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/Dashboard.png') }}" alt=""  width="20px" height="20px"></span>
...
@can('manage_staff')
    <li class="nav-item {{ Request::is('admin/staffs*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('staffs.index') }}">
            ...
            <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/staff.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
...
<li class="nav-item {{ Request::is('doctors/appointments*','doctors/patient*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-4" aria-current="page"
       href="{{ route('doctors.appointments') }}">
        ...
        <span class="aside-menu-icon pe-3"><img src="{{ asset('assets/image/icons/patients.png') }}" alt=""  width="20px" height="20px"></span>
...
<li class="nav-item {{ Request::is('doctors/transactions*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-4" aria-current="page"
       href="{{ route('doctors.transactions') }}">
...
<li class="nav-item {{ Request::is('patients/appointments*','patients/patient-appointments-calendar*','patients/doctors*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-4" aria-current="page"
...
@can('manage_doctors')
    <li class="nav-item {{ Request::is('admin/doctors*','doctors/doctor-sessions*','admin/doctor-sessions*') ? 'active' : '' }}">
        ...
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/doctors.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
...
@can('manage_patients')
    ...
    <li class="nav-item {{ Request::is('admin/patients*') ? 'active' : '' }}">
        ...
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/patients.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
...
@can('manage_appointments')
    ...
    <li class="nav-item {{ Request::is('admin/appointments*','admin/admin-appointments-calendar*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           href="{{ route('appointments.index') }}">
            {{-- <span class="aside-menu-icon pe-3"><i class="fas fa-calendar-alt"></i></span> --}}
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/appoint.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
    ...
    <li class="nav-item {{ Request::is('admin/transactions*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           href="{{ route('transactions') }}">
            {{-- <span class="aside-menu-icon pe-3"><i class="fas fa-money-bill-wave"></i></span> --}}
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/trans.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
        ...
        <li class="nav-item {{ Request::is('admin/visits*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page"
               href="{{ route('visits.index') }}">
                {{-- <span class="aside-menu-icon pe-3"><i class="fas fa-procedures"></i></span> --}}
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/visit.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
...
@can('manage_services')
    <li class="nav-item {{ Request::is('admin/services*','admin/service-categories*') ? 'active' : '' }}">
        ...
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/services.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
...
@can('manage_specialities')
    <li class="nav-item {{ Request::is('admin/specializations*') ? 'active' : '' }}">
        ...
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/spec.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
...
@can('manage_settings')
    <li class="nav-item {{ Request::is('admin/settings*','admin/roles*','admin/currencies*','admin/clinic-schedules*','admin/countries*','admin/states*','admin/cities*','admin/holidays*') ? 'active' : '' }}">
        ...
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/settings.png') }}" alt=""  width="20px" height="20px" style="background-color: transparent;"></span>
