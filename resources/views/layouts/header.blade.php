<header class='d-flex align-items-center justify-content-between flex-grow-1 header px-3 px-xl-0'>
    ...
    <ul class="nav align-items-center">
        ...
        @else
                ...
                <li class="px-sm-3 px-2">
                    <a href="{{ route('appointments.index') }}" style="text-decoration:none; font-weight:bold; font-size:15px; color:#2187BA;">{{__('messages.admin_dashboard.Appointments_History')}}</a>
            </li>

                <li class="px-sm-3 px-2">
                    <a class="btn btn-primary" href="{{ route('patients.create')}}" style="background: #2187BA">+ {{__('messages.admin_dashboard.New_Patient')}}</a>
                </li>
