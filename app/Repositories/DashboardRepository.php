...
class DashboardRepository
{
    ...
    public function getData()
    {
        ...
        $data['totalpatients'] = Patient::orderBy('created_at', 'DESC')->take(4)->get();
        $data['totaldoctors'] = Doctor::orderBy('created_at', 'DESC')->take(4)->get();
        $data['totaltransactions'] = Transaction::get();
